...
import WhiteLogo from "src/assets/images/Logo.svg";
import { v4 as uuidv4 } from "uuid";
// import { useRouter } from "next/router";
import {
  isChildrenPageActive,
  isParentPageActive,
} from "src/utils/daynamicNavigation";
      ...
      >
        <div className="flex items-center px-6 py-6 xl:px-24 ">
              ...
              <ul className="flex flex-col justify-center lg:flex-row">
                ...
                <li className="js-nav-dropdown group relative">
                  <button className="dropdown-toggle text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5 w-full">
                    <span
                      className={
                        isParentPageActive(home.pages, currentPath)
                          ...
                          <span className="dark:hover:bg-jacarta-600  hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors justify-between ">
                            <span
                              className={`font-display ${
                                isChildrenPageActive(page.path, currentPath)
                                  ? "text-accent dark:text-accent"
                                  : "text-jacarta-700"
                ...
                <li className="js-nav-dropdown group relative">
                  <button className="dropdown-toggle text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5 w-full">
                    <span
                      className={
                        isParentPageActive(page.pages, currentPath)
                          ? "text-accent dark:text-accent"
                          : ""
                      }
                    >
                ...
                <li className="js-nav-dropdown nav-item dropdown group relative">
                  <button className="dropdown-toggle text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5 w-full">
                    <span
                      className={
                        isParentPageActive(explore.pages, currentPath)
                          ? "text-accent dark:text-accent"
                          : ""
                      }
                    >
                ...
                <li className="js-nav-dropdown group relative">
                  <button className="dropdown-toggle text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5 w-full">
                    <span
                      className={
                        isParentPageActive(resource.pages, currentPath)
                          ? "text-accent dark:text-accent"
                          : ""
                      }
                    >
          ...
          <div className="hidden  justify-end lg:flex">
            {/* <!-- CTA --> */}
            <Link to="/collection/explore_collection">
              <span className="rounded-full bg-white py-3 px-8 text-center font-semibold text-accent shadow-white-volume transition-all hover:bg-accent-dark hover:text-white hover:shadow-accent-volume">
                {" "}
                Marketplace
              </span>
            </Link>
                  ...
                  <li key={page.id} onClick={() => setToggle(false)}>
                    <Link to={page.path}>
                      <span className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center rounded-xl px-5 py-2 transition-colors">
                        <span
                          className={`font-display ${
                            isChildrenPageActive(currentPath, page.path)
                              ? "text-accent dark:text-accent"
                              : "text-jacarta-700"
                          } text-sm dark:text-white`}
                        >
              ...
              <Link to="/create">
                <span>
                  <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5">
                    <span
                      className={
                        isChildrenPageActive("/create", currentPath)
                          ? "text-accent dark:text-accent"
                          : ""
                      }
                    >
